      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="flex flex-col gap-10 mt-12">
          ...
          <ScrollReveal delay={200}>
            <div
              className="glass-pink hover:shadow-[0_24px_80px_rgba(249,168,212,0.15)] transition-all duration-500 overflow-hidden group"
              style={{ borderRadius: '24px' }}
            >
              <div className="grid grid-cols-1 lg:grid-cols-[1fr,2fr] min-h-full">
                ...
                <div className="p-8 lg:p-10 bg-white/[0.02] border-b lg:border-b-0 lg:border-r border-white/10 flex flex-col justify-between">
                  <div>
                    <div className="flex items-center gap-3 mb-6">
                      <div className="w-12 h-12 rounded-2xl glass-pink flex items-center justify-center text-2xl group-hover:scale-110 transition-transform duration-500">
                        ✨
                      </div>
                      <span className="section-label mb-0" style={{ color: '#f9a8d4' }}>Creative</span>
                    </div>
                    ...
                    <p className="font-body font-bold text-sm tracking-[0.2em] uppercase mb-1" style={{ color: '#f9a8d4' }}>
                      Instagram & Social Media
                    </p>
                    
                    <p className="font-body text-white/50 text-sm mb-8">2026 – Present</p>
                  </div>

                  <div
                    className="inline-flex items-center gap-2 px-5 py-2.5 text-[10px] text-[#f9a8d4] rounded-full font-body font-bold tracking-[0.2em] uppercase self-start"
                    style={{ border: '1px solid rgba(249,168,212,0.3)', background: 'rgba(249,168,212,0.08)' }}
                  >
                    <span className="w-1.5 h-1.5 rounded-full bg-[#f9a8d4] animate-pulse" />
                    Open for Collabs
                  </div>
                </div>
                ...
                <div className="p-8 lg:p-10 flex flex-col justify-center">
                  <p className="font-body text-xs text-white/30 tracking-widest uppercase mb-6">Roles & Impact</p>
                  <ul className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                    {[
                      ...
                      <li key={i} className="flex items-start gap-4 text-white/70 text-sm font-body leading-relaxed">
                        <span className="flex-shrink-0 mt-1 text-[10px]" style={{ color: '#f9a8d4' }}>✦</span>
                        <span>{point}</span>
                      </li>
                    ))}
                  </ul>
                  ...
                  <div className="mt-10 pt-8 border-t border-white/5 flex items-center gap-4">
                    <div className="flex -space-x-3">
                      {[1, 2, 3].map(i => (
                        <div key={i} className="w-8 h-8 rounded-full border-2 border-[#1a0a2e] bg-white/10 flex items-center justify-center text-[10px]">👤</div>
                      ))}
                    </div>
                    <p className="text-xs text-white/40 font-body">Collaborating with creators and brands globally</p>
                  </div>
                </div>
              </div>
            </div>
