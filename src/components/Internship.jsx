    ...
    <ScrollReveal delay={index * 100}>
      ...
      >
        ...
        <div className="p-9 flex-1 flex flex-col relative z-20">
          ...
          <p className="text-[#fdfbf7]/50 text-[11px] font-medium tracking-widest uppercase mb-4">
            {item.department}
          </p>

          {/* Compact Timeline Block */}
          <div className="flex flex-col gap-2 mb-4 p-3 rounded-xl bg-[#fdfbf7]/[0.02] border border-[#fdfbf7]/5">
          ...
          <div className="relative font-body text-[#fdfbf7]/40 text-sm mb-6 leading-relaxed">
            <motion.div
              initial={false}
